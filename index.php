...
/*Check to see if the user already exists*/?>
	<h4>Please enter your Michigan Tech username</h4>
	<form action="index.php" method="get" autocomplete="on">
	<input class="input-text" type="text" name="u" autofocus="autofocus" /> <?php /*Store username to check if in DB*/?>
	<input type="submit" class="input-submit" value="Submit">
	</form> <?php
	}

else{
$user_check = pg_escape_string($_REQUEST['u']);
